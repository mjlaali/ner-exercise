...
class CNN_LSTM_Model:
    ...
    def construct_model(self, char_embedding_size, nb_filters, word_embedding_size, embedding_weights, lstm_dim):
        ...
        model_word.add(Embedding(self.word_vocab_size, word_embedding_size, input_length=self.max_sent_len
    ...
    def fit(self, X_word_train, X_char_train, Y_train, batch_size, max_epochs):
        ...
        X_train = [X_char_train[:validation_start_idx], X_word_train[:validation_start_idx]]
        X_valid = [X_char_train[validation_start_idx:], X_word_train[validation_start_idx:]]
        self.model.fit(X_train, Y_train[:validation_start_idx],
                       batch_size=batch_size, nb_epoch=max_epochs,
                       validation_data=(X_valid, Y_train[validation_start_idx:]),
...
def train_model(train_file, wordvects_file):
    ...
    print('Words={}, Tags={}, Max sent len={}, Max word len={}'.format(word_vocab_size, output_vocab_size,
    ...
    model = model_generator.construct_model(60, 100, 50, preprocessor.get_embedding_weights(), 50)
    print(model.summary())
